...
@objc open class ZAlertView: UIViewController {
    ...
    public static var wid  : UIWindow!
    ...
    func setupWindow() {
        ...
        self.alertWindow.rootViewController = window.rootViewController
    ...
    override open func viewWillLayoutSubviews() {
        ...
        if let title = self.alertTitle {
            ...
            self.separator.frame = CGRect(x: 8, y: childHeight + 15, width: width - 20, height: 0)
            height          += childHeight
        } else {
            self.height = 0
        }
